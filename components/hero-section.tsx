...
const pricingOptions = [
  ...
  {
    id: "two",
    label: "2 Pots + 1 OFFERT",
    subtitle: "3 pots au total",
    price: "54.90",
  ...
  {
    id: "three",
    label: "3 Pots + 2 OFFERTS",
    subtitle: "5 pots au total",
    price: "79.90",
        ...
        <div className="relative flex items-center justify-center">
          <div className="relative">
            ...
            <div className="overflow-hidden rounded-2xl bg-secondary">
              ...
              <img
                src="/images/youy-gum-product.jpg"
                alt="YOUY GUM Sleep Gummies - Pot de gummies pour le sommeil"
                width={600}
                height={600}
                loading="eager"
                fetchPriority="high"
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        {opt.subtitle} | {"Economisez"} {opt.savings}{""}
                      </p>
                    </div>
                  </div>
